...
import { onAuthStateChanged as firebaseOnAuthStateChanged, RecaptchaVerifier as FirebaseRecaptchaVerifier, signInWithPhoneNumber as firebaseSignInWithPhoneNumber, getAuth, GoogleAuthProvider, OAuthProvider, signInWithPopup } from 'firebase/auth';
...
export { app, appleProvider, auth, googleProvider };
export default app;